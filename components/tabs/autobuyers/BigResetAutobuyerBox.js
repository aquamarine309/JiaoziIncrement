...
export default {
  ...
  computed: {
    autobuyer: () => Autobuyer.bigReset,
    modes: () => [
AUTO_BIG_RESET_MODE.AMOUNT,
AUTO_BIG_RESET_MODE.TIME,
AUTO_BIG_RESET_MODE.X_HIGHEST,
]
  },
  watch: {
