export const languages = {
  "zh-CN": {
    ...
    resources: {
      ...
      collection_7_description: "售出时获得更多的饺子币。",
      collection_8_description: "饺子售出不再有软下限，制造器可获得基于当前饺子币数量的加成。",
      collection_9_description: "解锁下一级制造器，售出的需求降低至 $1，同时降低饺子馅的初始价格。",
      ...
      challenge_4_description: "你不能激活任何收集饺子，制造器的效果 $2。售出的需求提高到 $1。",
  ...
  "en": {
    ...
    resources: {
      ...
      stuffingDes: "Tasty fillings allow you to unlock next Maker.",
      ...
      collection_4_description: "You can gain free wrappers from each filling, and gained Dumpling Collections are multiplied based on current Dumpling Doughs.",
      ...
      collection_7_description: "Dumpling Doughs gain ^x.",
      collection_8_description: "Dumpling Doughs gain will not decrease before reaching most dumplings, all the makers are multiplied based on current Dumpling Doughs.",
      collection_9_description: "You can buy next Maker. Fillings' cost are reduced! You can sell dumplings just when you reach $1!",
      ...
      stuffingAutobuyer: "Filling Autobuyer",
      ...
      unlimited: "Unlimited",
      unlockAutobuyer: "Requirement: $1 Total Dumpling Doughs",
      ...
      achievement_13_name: "Triple Dumpling Combo",
      achievement_14_name: "Is there a limit? Yesn't!",
      ...
      achievement_23_name: "Easiest episode yet!",
      achievement_24_name: "I like upgrades",
      achievement_25_name: "Way ahead",
      ...
      achievement_33_name: "Easiest Episode Yet!",
      ...
      achievement_38_name: "Gone with the Steam",
      ...
      challenge_2_description: "Gained Dumpling Doughs has significantly decreased.",
      challenge_3_description: "Automatically purchase Dumpling Wrapper, and the price of Dumpling Filling increases based on Dumpling Wrapper.",
      ...
      challenge_6_description: "You can only buy $1 Filling, but makers gain a multiplier from Collection counts.",
      ...
      steamer_upgrade_keepStuffing: "Keep all Fillings on Collection",
      steamer_upgrade_resetRequirement: "You can collect without all Filling bought",
      ...
      steamer_upgrade_nextMaker: "Increase Filling's cap by $1",
