export const languages = {
  "zh-CN": {
    ...
    resources: {
      ...
      C_6: "增加购买制造器的加成。",
      C_7: "售出时获得更多的饺子币。",
      C_8: "饺子售出不再有软下限，制造器可获得基于当前饺子币数量的加成。",
      C_9: "解锁下一级制造器，售出的需求降低至 $1，同时降低饺子馅的初始价格。",
      ...
      chall4: "你不能激活任何收集饺子，制造器的效果$2。售出的需求提高到$1。",
      chall5: "你不能激活第三行的收集饺子。 只有$1的饺子皮有效果。",
