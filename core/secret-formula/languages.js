export const languages = {
  "zh-CN": {
    ...
    resources: {
      ...
      collection: "收集饺子",
      collections: "收集饺子",
      bigResetDes: "制造器已达到上限，但饺子馅给你准备了 $1，你可以在$1后获得！",
      ...
      saveCreatedStat: "本存档在的创建时间为$1。 ($1之前)",
      ...
      ach37: "排列组合大题",
      ach38: "一去不返",
      offlineProgressInfo: "游戏以较低的精度运行，以便快速计算你离线时获得的资源。如果你想了解相关技术的详细信息，请参阅“游戏帮助”中的“离线进度”条目。如果你不想等待了，想早点玩游戏，你可以点击“加速”按钮，用一半的游戏刻模拟剩下的时间(至少剩下$1个游戏刻)。点击“跳过”按钮后将在$1个游戏刻内计算剩余的离线时间。",
      remaining: "剩余",
      tick: "游戏刻",
      buyOne: "购买一个",
      ach21_d: "获得你的第一个收集饺子。",
      ...
      chall4: "你不能激活任何收集饺子，制造器的效果$1。出售的需求提高到$1。",
  ...
  "en": {
    ...
    resources: {
      ...
      bigResetDes: "Top-tier Maker is unlocked. But you can perform the $1 to gain $1.",
      ...
      branch: "Branch",
      branches: "Branches",
      collInfo: "You can activate up to $1 at the same time ($1 activated)",
      ...
      mixtureInfo: "$1 provide a multiplier to $1:",
      and: "and",
      en_comma: ",",
      general: "General",
      ...
      saveCreatedStat: "Your save was created on $1 ($1 ago)",
      ...
      chall4: "You can't activate any Dumpling Collections. All Maker's production is $1. The requirement of sale raises to $1.",
