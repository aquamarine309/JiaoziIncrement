...
export const normalChallenges = [
  {
    id: 1,
    description: () => $t("challenge_1_description"),
    reward: {
  ...
  {
    id: 2,
    description: () => $t("challenge_2_description"),
    effect: 0.225,
    reward: {
  ...
  {
    id: 3,
    description: () => $t("challenge_3_description"),
  ...
  {
    id: 4,
    description: () => $t("challenge_4_description", [format(1e21, 2), formatPow(0.82, 0, 2)]),
    effect: 0.82,
    reward: {
      description: () => `基于蒸笼次数的升级的效果变为原来的 ${formatPow(1.3, 0, 1)}`,
      effect: 1.3
    }
  },
  {
    id: 5,
    description: () => $t("challenge_5_description", [formatPercents(0.05)]),
    effect: 0.05,
    reward: {
  ...
  {
    id: 6,
    description: () => $t("challenge_6_description", [formatInt(1)]),
  ...
  {
    id: 7,
    description: () => $t("challenge_7_description", [formatInt(1)]),
    reward: {
  ...
  {
    id: 8,
    description: () => $t("challenge_8_description", [formatPow(0.725, 2, 2)]),
    effect: 0.725,
    reward: {
