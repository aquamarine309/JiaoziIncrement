...
export const steamerUpgrades = {
  makerPow: {
    id: "makerPow",
    cost: 1,
    description: () => $t("SU_makerPow", [formatPow(1.2, 1, 1)]),
    effect: 1.2
  },
  steamerCountMult: {
    id: "countMult",
    cost: 2,
    description: () => $t("SU_steamerCountMult"),
  ...
  keepWrapper: {
    id: "keepWrapper",
    cost: 20,
    description: () => $t("SU_keepWrapper", [formatPercents(0.5)]),
    effect: () => Math.floor(player.wrapper * 0.5),
  },
  scGen: {
    id: "scGen",
    cost: 4,
    description: () => $t("SU_scGen"),
    ...
    formatEffect: value => {
      ...
      return $t("SU_scGen_effect", [Time.bestSteamer.times(5).toStringShort(), format(value, 2)]);
    },
  ...
  collectionsMult: {
    id: "colMult",
    cost: 1,
    description: () => $t("SU_collectionsMult", [formatX(5)]),
    effect: 5
  },
  commonPower: {
    id: "commonPower",
    cost: 3,
    description: () => $t("SU_commonPower", [formatPow(3)]),
    effect: 3,
  ...
  keepStuffing: {
    id: "keepStuffing",
    cost: 50,
    description: () => $t("SU_keepStuffing"),
    checkRequirement: () => SteamerUpgrade.keepWrapper.isBought
  },
  resetRequirement: {
    id: "resetReq",
    cost: 300,
    description: () => $t("SU_resetRequirement"),
    checkRequirement: () => SteamerUpgrade.keepCollections.isBought
  },
  keepCollections: {
    id: "keepCollections",
    cost: 100,
    description: () => NormalChallenges.completed.length === 8 ? $t("SU_keepCollections_all") : $t("SU_keepCollections", [format(NormalChallenge(1).reward.effectOrDefault(9) / 9, 2)]),
    checkRequirement: () => SteamerUpgrade.keepStuffing.isBought
  },
  scMult: {
    id: "scMult",
    cost: 10,
    description: () => $t("SU_scMult"),
  ...
  unlockSteamerAuto: {
    ...
    cost: 15,
    description: () => $t("SU_unlockSteamerAuto"),
    checkRequirement: () => SteamerUpgrade.timeBoost.isBought
  },
  nextMaker1: {
    id: "nextMaker1",
    cost: 20,
    description: () => $t("SU_nextMaker", [format(1)])
  },
  nextMaker2: {
    id: "nextMaker2",
    cost: 50,
  ...
  coinMult: {
    ...
    description: () => $t("SU_coinMult", [formatX(2)]),
